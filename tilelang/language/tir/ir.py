...
sm120_mma_blockscaled_kblock_fulltile = _tir_op.sm120_mma_blockscaled_kblock_fulltile
sm120_mma_blockscaled_kblock_fulltile_ab_owner_wide = _tir_op.sm120_mma_blockscaled_kblock_fulltile_ab_owner_wide
sm120_mma_blockscaled_kblock_fulltile_afull_bpanel_owner_wide = _tir_op.sm120_mma_blockscaled_kblock_fulltile_afull_bpanel_owner_wide
sm120_mma_blockscaled_kblock_fulltile_package_pingpong = _tir_op.sm120_mma_blockscaled_kblock_fulltile_package_pingpong
sm120_mma_blockscaled_cute_consumer_bridge = _tir_op.sm120_mma_blockscaled_cute_consumer_bridge
